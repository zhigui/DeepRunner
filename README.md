...
- **Application updates and releases**: Packaged builds use `electron-updater` to check for and download updates from a pinned GitHub Releases source. The release pipeline can produce macOS, Windows, and Linux artifacts and validate their signatures and metadata.
